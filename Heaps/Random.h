...
public:
	...
	static double Real(float a, float b) { return Get().IReal(a, b); }

	static double Real(float a) { return Get().IReal(0., a); }

	static double R100() { return Get().IReal(0., 100.); }

	static double Normalised() { return Get().IReal(); }

	static int Int(int a, int b) { return Get().IInt(a, b); }

	static int Int(int b) { return Get().IInt(0, b); }

	static int I100() { return Get().IInt(0, 99); }
